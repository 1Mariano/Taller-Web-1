...
<main>
    <h3 class="m-4 text-center">Productos de alimentación</h3>
    <!-- Example Code -->
    <h3 class="m-4 text-center">Productos frescos</h3>
    ...
    <<h3 class="m-4 text-center">Productos congelados</h3>
    <div class="d-flex flex-wrap gap-5 justify-content-center">
        <c:forEach var="item" items="${lista}">
    ...
    <<h3 class="m-4 text-center">Productos de almacén</h3>
    <div class="d-flex flex-wrap gap-5 justify-content-center">
        <c:forEach var="item" items="${lista}">
